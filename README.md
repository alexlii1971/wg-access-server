...
**Username: admin**, 
**Password:**
Please note that WG_ADMIN_PASSWORD="example", so adjust your password for admin.
**Port**
If there is any other docker UI tools is running at 8000 port like portainer, please change the port to other port to avoid conflicts.
